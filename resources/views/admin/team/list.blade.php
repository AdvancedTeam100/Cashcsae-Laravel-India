                ...
                <div class="card-header">
                  ...
                  Team Member List
                    ...
                    <div class="d-flex fluid">
                        <input type="search" name="search" class="form-control" placeholder="search Team Member" aria-label="search advertisers">
                        &nbsp;<button type="submit" class="btn btn-success">Search</button>
                    </div>
                    <!-- End Search -->
						</form></div>
                        <a  align="right" style="float:right !important;" href="{{route('admin.team.export-all')}}" class="btn btn-danger  float-right">Export All </a>&nbsp;
               </div>
              <div class="card-body">
                  ...
                  <table id="example" class="display" style="width:100%">
                    ...
                    <tbody class="table-tbody">
                           @foreach($em as $k=>$e)
                               ...
                               <img src="{{asset('storage/app/public/admin')}}/{{$e['image']}}" alt="no image" style="width:80px">
                              
                                </td>
                             
                                    <td class="sort-name"> {{$e['f_name']}} {{$e['l_name']}}</td>
                                     <td class="sort-email"> {{$e['email']}}</td>
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item"
                                                    href="{{route('admin.team.edit',[$e['id']])}}" title="edit category">Edit
                                                </a>
                                                <a  href="{{route('admin.team.delete',[$e['id']])}}" class="dropdown-item" href="javascript:"
