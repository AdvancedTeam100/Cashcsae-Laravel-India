...
@section('content')
          ...
          <div class="container-xl">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{route('admin.team.update',[$e['id']])}}" method="post" enctype="multipart/form-data">
                    @csrf
                     <div class="mb-3">
                       <label class="form-label required">Role</label>
                        <select id="exampleFormControlSelect1" name="role_id" class="form-control js-select2-custom" required>
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="f_name" id="f_name" value="{{$e['f_name']}}" placeholder="john" />
                            </div>
                             <div class="mb-3">
                              <label class="form-label required">Last name</label>
                              <input type="text" class="form-control" name="l_name" id="l_name" value="{{$e['l_name']}}" placeholder="doe"/>
                            </div>
                             <div class="mb-3">
                              <label class="form-label required">Phone</label>
                              <input type="phone" class="form-control" name="phone" id="phone" value="{{$e['phone']}}" placeholder="9999999999"/>
                            </div>
                             <div class="mb-3">
                              <label class="form-label required">email</label>
                              <input type="email" class="form-control" name="email" id="email" value="{{$e['email']}}" placeholder="xyz@gmail.com"/>
                               ...
                               <div class="form-group"  id="viewerbox" style="margin-bottom:0%;">
                                <center>
                                    <img style="width: 200px;border: 1px solid #3399db; border-radius: 10px; max-height:200px; padding: 11px;" id="viewer"
                                            src="{{asset('storage/app/public/admin')}}/{{$e['image']}}" alt="Team thumbnail"/>
                                </center>
                            </div>
