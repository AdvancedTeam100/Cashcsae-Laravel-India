...
@section('title','Admitad Campaigns List')
    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                ...
                <a align="right" style="float:right !important;" href="{{route('admin.admitadcampaigns.export-all')}}"
                    ...
                    <table id="example" class="display table-responsive" style="width:100%">
                        ...
                        <tbody class="table-tbody">
                            ...
                            <tr>
                                ...
                                <td class="sort-name"> {{ Str::limit($e['partner']['name'], 30) }} </td>
