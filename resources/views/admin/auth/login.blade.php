      ...
      <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
            ...
            <div class="container-tight">
              ...
              <div class="card card-md">
                <div class="card-body">
                  ...
                  <form action="{{route('admin.auth.logincheck')}}"  method="post" autocomplete="on">
                     @csrf
                    <div class="mb-3">
            ...
            <div class="container-tight">
              ...
              <div class="card card-md">
                <div class="card-body">
                  ...
                  <form action="{{ route('system_settings') }}"  method="post" autocomplete="on">
                    @csrf
                    <div class="mb-3">
          ...
          <div class="col-lg d-none d-lg-block">
            <img src="{{url('assets/theme_assets/static/undraw_secure_login_pdn4.svg')}}" height="300" class="d-block mx-auto" alt="">
          </div>
        </div>
      </div>
    </div>
