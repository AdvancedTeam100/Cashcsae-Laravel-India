				    ...
				    <div class="form-group"  id="viewerbox" style="margin-bottom:0%;">
						 <center>
							 <img style="width: 200px;border: 1px solid #3399db; border-radius: 10px; padding: 11px;" id="viewer"
								  @if(isset($coupon))
								  src="{{asset('storage/app/public/coupon')}}/{{$coupon['banner_image']}}"
								  @else
				   ...
				   <div class="row">
				    ...
				    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="link" id="link" value="{{$coupon['url']}}"/>
                            </div>
					   </div>
					     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="mb-3">
                              <label class="form-label required">Button Text</label>
                              <input type="text" class="form-control" name="button_text" id="button_text" value="{{$coupon['button_text']}}"/>
                            </div>
					   </div>
					 </div>
				     <div class="row">
				    ...
				    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				             <div class="mb-3">
                                       ...
                                       <input type="text" class="form-control" name="heading" id="heading" value="{{$coupon['heading']}}"/>
                                    </div>
						</div>
						  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				             <div class="mb-3">
						  ...
						  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				              <div class="mb-3">
                                        ...
                                        <select name="adv_id" class="js-data-example-ajax form-control"  title="Select Offer">
											...
											<option value="{{$partner->id}}"  @if($coupon['adv_id']==$partner->id) selected @endif>{{$partner->name}}</option>
											@endforeach
