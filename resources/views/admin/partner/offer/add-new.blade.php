...
@section('content')
          ...
          <div class="container-xl">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{route('admin.ads.added')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                       <label class="form-label required">Ad Name</label>
                       <input type="text" name="name" placeholder="enter Ad name" class="form-control" required>
                    </div>
                     <div class="mb-3">
                      ...
                      <div class="mb-3">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="button_text" id="button_text" value="{{old('button_text')}}" placeholder="ex: grab deal"/>
                            </div>
                            <div class="mb-3">
                              <label class="form-label required">Button Url</label>
                              <input type="text" class="form-control" name="button_url" id="button_url" value="{{old('button_url')}}" placeholder="ex: https:://xyz.com"/>
                            </div>
                              ...
                              <div class="form-group"  id="viewerbox" style="display:none;margin-bottom:0%;">
                                <center>
                                    <img style="width: 200px;border: 1px solid #3399db; border-radius: 10px; max-height:200px; padding: 11px;" id="viewer"
                                            src="{{asset('public/theme_assets/img')}}/upload1.png" alt="offer banner"/>
                                </center>
                            </div>
