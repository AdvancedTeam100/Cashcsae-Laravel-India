...
@section('title','Update terms and conditions')
...
@section('content')
          ...
          <div class="container-xl">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{route('admin.info-settings.update_about_us')}}" method="post" enctype="multipart/form-data">
                    @csrf
                             <div class="mb-3">
                              <label class="form-label required">About Us</label>
								  @php($pp=\App\Models\BusinessSetting::where('key','about_us')->first()->value)
                              <textarea class="form-control" name="tnc" id="summernote1">{{$pp}}</textarea>
                            </div>
