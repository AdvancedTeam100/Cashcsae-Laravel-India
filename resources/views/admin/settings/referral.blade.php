...
@section('title','Update Referral Settings')
...
@section('content')
          ...
          <div class="container-xl">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{route('admin.referral-settings.update-referral')}}" method="post" enctype="multipart/form-data">
                    @csrf
				   <div class="row">    
				    <div class="col-lg-6 col-sm-12 col-xs-12 col-md-6">
						 @php($signup=\App\Models\BusinessSetting::where('key','signup_refer')->first())
                            ...
                            <div class="mb-3">
                              ...
                              <label class="form-label required">Signup Referral</label>
                                 ...
                                 <input type="number" name="signup_refer" value="{{$signup->value??''}}" class="form-control"
                        ...
                        @php($per_order_refer_percentage=\App\Models\BusinessSetting::where('key','per_order_refer_percentage')->first())
                              ...
                              <label class="form-label required">Per Order Referral Percentage</label>
                                 ...
                                 <input type="number" name="per_order_refer_percentage" value="{{$per_order_refer_percentage->value??''}}" class="form-control"
                               placeholder="" step="0.1" min="1"  required>
                            </div>
					   </div>
