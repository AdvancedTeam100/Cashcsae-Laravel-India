...
@section('content')
          ...
          <div class="container-xl">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{route('admin.info-settings.update_privacy_policy')}}" method="post" enctype="multipart/form-data">
                    @csrf
                             <div class="mb-3">
                              ...
                              <textarea class="form-control" name="privacy_policy" id="summernote1">{{$pp}}</textarea>
                            </div>
