...
@section('title','Update Admob Settings')
...
@section('content')
	...
	<div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">	  
            ...
            <div class="content">
				 ...
				 <form action="{{route('admin.admob.update',$interstitial->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
					<div class="row">
					  ...
					  <div class="row">
                                     <div class="col-12 col-lg-6 col-md-6"  style="float:left">
                                         <div class="mb-3">
                                            ...
                                            <input type="text" name="ad_id" class="form-control" placeholder="" value="{{$interstitial->ad_id}}" required>
                                         </div>
...
@foreach($banner as $ban)
								<div class="modal fade" id="exampleModal{{$ban->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel{{$ban->id}}" aria-hidden="true">
								  <div class="modal-dialog" role="document">
									   <form action="{{route('admin.admob.update',$ban->id)}}" method="post" enctype="multipart/form-data">
                                         @csrf
									<div class="modal-content">
									  ...
									  <div class="modal-body">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12">
                                         <div class="mb-3">
                                            <label class="form-label required" for="exampleFormControlInput1">Ad Id</label>
                                            <input type="text" name="ad_id" class="form-control"  value="{{$ban->ad_id}}" required>
                                         </div>
