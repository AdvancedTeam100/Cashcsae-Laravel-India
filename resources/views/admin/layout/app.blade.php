...
<!-- END Pixel Code -->
  ...
  @stack('script')
    <!-- Libs JS -->
    <script src="{{url('assets/theme_assets/libs/apexcharts/dist/apexcharts.min.js')}}" defer></script>
    <script src="{{url('assets/theme_assets/libs/jsvectormap/dist/js/jsvectormap.min.js')}}" defer></script>
    <script src="{{url('assets/theme_assets/libs/jsvectormap/dist/maps/world.js')}}" defer></script>
    <script src="{{url('assets/theme_assets/libs/jsvectormap/dist/maps/world-merc.js')}}" defer></script>
    <!-- Tabler Core -->
    <script src="{{url('assets/theme_assets/js/tabler.min.js')}}" defer></script>
    <script src="{{url('assets/theme_assets/js/demo.min.js')}}" defer></script>
