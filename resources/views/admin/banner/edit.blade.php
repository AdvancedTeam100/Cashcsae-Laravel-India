				             ...
				             <div class="mb-3">
                                       <label class="form-label required">Banner Type</label>
                                        <select name="type" class="form-control" onchange="banner_type_change(this.value)">
                                            <option value="offer" @if($banner['type']=='offer') selected @endif>Offer</option>
                                            <option value="url"  @if($banner['type']=='url') selected @endif>URL</option>
                                        </select>
                                    </div>
						</div>
						  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				              <div class="mb-3" id="offer">
                                        ...
                                        <select name="offer_id" class="js-data-example-ajax form-control"  title="Select Offer">
											...
											<option value="{{$offer->id}}" @if($banner['offer_id']==$offer->id) selected @endif>{{$offer->name}}</option>
											@endforeach
				   ...
				   <div class="row">
				    ...
				    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				             <div class="mb-3">
                                       ...
                                       <input type="text" class="form-control" name="heading" id="heading" value="{{$banner['heading']}}"/>
                                    </div>
						</div>
						  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				             <div class="mb-3">
