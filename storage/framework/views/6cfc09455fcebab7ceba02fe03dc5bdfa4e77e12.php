          ...
          <div class="container-xl">
            <div class="card">
				<div class="card-header">
                    ...
                    <!-- End Search -->
						</form></div>&nbsp; <a  align="right" style="float:right !important;" href="<?php echo e(route('admin.cuelinksadvertisers.export-all-advertiser')); ?>" class="btn btn-danger  float-right">Export All </a>&nbsp;</div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cash.codefuse.org/httpdocs/newcashfuse/resources/views/admin/cuelinks/partner/index.blade.php ENDPATH**/ ?>