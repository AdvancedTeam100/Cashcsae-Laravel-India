<?php $__env->startSection('title','Advertiser List'); ?>
          ...
          <div class="container-xl">
            <div class="card">
				<div class="card-header">
                    ...
                    <!-- End Search -->
						</form></div>&nbsp;<a  align="right" style="float:right !important;" href="<?php echo e(route('admin.advertiser.export-all')); ?>" class="btn btn-danger  float-right">Export All </a>&nbsp;
					 <a  align="right" style="float:right !important;" href="<?php echo e(route('admin.advertiser.add')); ?>" class="btn btn-primary  float-right">Add New </a></div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cash.codefuse.org/httpdocs/newcashfuse/resources/views/admin/partner/list.blade.php ENDPATH**/ ?>