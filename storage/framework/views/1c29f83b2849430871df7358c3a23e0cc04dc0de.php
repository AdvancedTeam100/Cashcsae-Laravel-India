    ...
    <div class="card">
        <div class="card-header">
            <div class="row w-100"> 
                ...
                <div class="col-6">                      
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addcountry" style="float:right"><?php echo e(__('Add Country')); ?></button>
                </div>           
            </div>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                                <div class="form-group">
                                    <label id="folderLabel"><?php echo e(__('Partner')); ?></label><br>
                                ...
                                <div class="form-group">
                                <label id="folderLabel"><?php echo e(__('Country Name')); ?></label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cash.codefuse.org/httpdocs/newcashfuse/resources/views/admin/country/list.blade.php ENDPATH**/ ?>