    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                ...
                <a align="right" style="float:right !important;" href="<?php echo e(route('admin.admitadcampaigns.export-all')); ?>"
                    ...
                    <table id="example" class="display table-responsive" style="width:100%">
                        ...
                        <tbody class="table-tbody">
                            ...
                            <tr>
                                ...
                                <td class="sort-name"> <?php echo e(Str::limit($e['partner']['name'], 30)); ?> </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Codefuse\ecom\cashfuse-new\resources\views/admin/admitad/campaigns/list.blade.php ENDPATH**/ ?>