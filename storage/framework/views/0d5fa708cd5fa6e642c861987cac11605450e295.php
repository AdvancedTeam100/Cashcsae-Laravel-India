<?php $__env->startSection('title','Admitad Campaigns List'); ?>
            ...
            <div class="card">
                  <div class="card-header">
                    ...
                    <div class="d-flex fluid">
                        <input type="search" name="search" class="form-control" placeholder="search campaigns" aria-label="search advertisers">
                        &nbsp;<button type="submit" class="btn btn-success">Search</button>
                    </div>
                    <!-- End Search -->
						</form></div>&nbsp;
                        <a  align="right" style="float:right !important;" href="<?php echo e(route('admin.admitadcampaigns.export-all')); ?>" class="btn btn-danger  float-right">Export All </a>&nbsp;</div>
              <div class="card-body">
                    ...
                    <tbody class="table-tbody">
                           <?php $__currentLoopData = $em; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                   ...
                                   <td class="sort-name"> <?php if($e['image']!=NULL): ?><img src="<?php echo e(asset('storage/app/public/offer')); ?>/<?php echo e($e['image']); ?>" alt="no image" style="width:80px"><br><br>
								   <?php endif; ?>
...
Change Image</button>
                              ...
                              <td class="sort-name"> <?php if($e['description']==NULL): ?>
										<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampl2eModal<?php echo e($e->id); ?>">
Add Description</button>
							...
							<p><?php echo e($e['description']); ?></p>
								...
								<td class="sort-name"> <?php echo e($e['partner']['name']); ?></td>
                              ...
                              <td class="sort-name"><?php echo e($e['category']['name']); ?> </td>
                                    ...
                                    <td class="sort-type">
									<a  href="<?php echo e(route('admin.cuelinkscampaigns.delete',$e['id'])); ?>" class="btn btn-danger"
                                                    onclick="return confirm('Are you sure?');" title="delete campaign">Delete
                                                </a>
...
<?php $__currentLoopData = $em; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="modal fade" id="exampleModal<?php echo e($e->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel<?php echo e($e->id); ?>" aria-hidden="true">
								  <div class="modal-dialog" role="document">
									   <form action="<?php echo e(route('admin.admitadcampaigns.update_cam_img',$e->id)); ?>" method="post" enctype="multipart/form-data">
                                         <?php echo csrf_field(); ?>
						...
						<!-- Description -->
							<div class="modal fade" id="exampl2eModal<?php echo e($e->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel<?php echo e($e->id); ?>" aria-hidden="true">
								  <div class="modal-dialog" role="document">
									   <form action="<?php echo e(route('admin.admitadcampaigns.update_desc',$e->id)); ?>" method="post" enctype="multipart/form-data">
                                         <?php echo csrf_field(); ?>
									<div class="modal-content">
									  <div class="modal-header">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cash.codefuse.org/httpdocs/newcashfuse/resources/views/admin/admitad/campaigns/list.blade.php ENDPATH**/ ?>