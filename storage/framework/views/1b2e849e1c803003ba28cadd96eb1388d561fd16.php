        ...
        <ul id="myMenu" class="navbar-nav" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  <?php echo e(Request::is('advertiser*')?'active':''); ?>">
            <a class="nav-link" href="<?php echo e(Route('admin.advertiser.list')); ?>">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mood-nerd" width="24"
                  height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                  <circle cx="12" cy="12" r="9"></circle>
              ...
              <span class="nav-link-title"> Advertiser</span>
            </a>
          </li>
          <?php endif; ?>
                    ...
                    <div class="dropdown-menu">
                      <div class="dropdown-menu-columns">
                        <div class="dropdown-menu-column">
                          ...
                          <a class="dropdown-item  <?php echo e(Request::is('cuelinkscampaigns/coupan*')?'active':''); ?>"
                            href="<?php echo e(route('admin.cuelinkscampaigns.coupan')); ?>"> Coupon</a>
                        </div>
                      </div>
                    </div>
                    <?php endif; ?>
              ...
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  ...
                  <div class="dropend">
                    ...
                    <?php endif; ?>
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('country')): ?>
                    <a class="dropdown-item <?php echo e(Request::is('admin/country*')?'active':''); ?>"
                      href="<?php echo e(Route('admin.country.index')); ?>">Country</a>
                    <?php endif; ?>
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('language')): ?>
                    <a class="dropdown-item <?php echo e(Request::is('admin/language*')?'active':''); ?>"
                      href="<?php echo e(Route('admin.language.index')); ?>">Language</a>
                    <?php endif; ?>
                    ...
                    <div class="dropend">
                      <a class="dropdown-item dropdown-toggle <?php echo e(Request::is('ad_network*')?'active':''); ?> <?php echo e(Request::is('admob*')?'active':''); ?> <?php echo e(Request::is('fbads*')?'active':''); ?>"
                        href="#sidebar-cards" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button"
                        aria-expanded="false">Ad Network</a>
                      <div class="dropdown-menu">
                        <?php if(\App\CentralLogics\Helpers::module_permission_check('ad_network')): ?>
...
</div><?php /**PATH C:\xampp\htdocs\Codefuse\ecom\cashfuse-new\resources\views/admin/layout/navbar.blade.php ENDPATH**/ ?>