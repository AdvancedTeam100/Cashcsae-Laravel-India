...
<?php $__env->startSection('title','Cuelinks Offer List'); ?>
                ...
                <div class="flex">
                    <form id="dataSearch">
                        ...
                        <div class="d-flex fluid">
                            <input type="search" name="search" class="form-control" placeholder="search offers"
                    ...
                    href="<?php echo e(route('admin.cuelinksoffers.export-all')); ?>" class="btn btn-danger  float-right">Export All
                </a>&nbsp;
            </div>
            <div class="card-body">
                    ...
                    <table id="example" class="display" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th><button class="table-sort" data-sort="sort-phone">campaign</button></th>
                                <th><button class="table-sort" data-sort="sort-image">Name</button></th>
                                <th><button class="table-sort" data-sort="sort-image">Banner Image</button></th>
                                ...
                                <th><button class="table-sort" data-sort="sort-image">Exclusive</button></th>
                        ...
                        <tbody class="table-tbody">
                            ...
                            <tr>
                                ...
                                <td class="sort-name"><?php echo e($e['campaign_name']); ?></td>
                                <td class="sort-name"><?php echo e($e['name']); ?></td>
                                <td class="sort-name">
                                    <?php if($e['banner_image']!=NULL): ?>
                                    <img src="<?php echo e(asset('storage/app/public/offer')); ?>/<?php echo e($e['banner_image']); ?>"
                                ...
                                <td class="sort-name"><?php echo e($e['start_date']); ?></td>
                                <td class="sort-name"><?php echo e($e['end_date']); ?></td>
                                ...
                                {
                                    window.location.href = "<?php echo e(route('admin.cuelinksoffers.offer_status',[$e->id,$e->status?0:1])); ?>"
                                }
                                }
                                </script>  
                                </td>
                                <td class="sort-role">
                                    <center><label class="form-check form-check-single form-switch"
                                            ...
                                            <input type="checkbox" class="form-check-input"
                                                onclick="myFunction<?php echo e($e->id); ?>()" id="stocksCheckbox<?php echo e($e->id); ?>"
                                                <?php echo e($e->exclusive?'checked':''); ?>>
                                        </label>
                                    </center>
                                    <script>
                                        function myFunction<?php echo e($e->id); ?>() {
                                      if (window.confirm('Do you want to change the Exclusive status?'))
                                    {
                                        window.location.href = "<?php echo e(route('admin.cuelinksoffers.exclusive',[$e->id,$e->exclusive?0:1])); ?>"
                                    }
                                    }
                                    </script>
                                ...
                                <td class="sort-type">
                                    <a href="<?php echo e(route('admin.cuelinksoffers.delete',$e->id)); ?>" class="btn btn-danger"
                                        href="javascript:" onclick="return confirm('Are you sure?');"
                                        title="delete Offers">Delete
                                    </a>
...
<div class="modal fade" id="exampleModal<?php echo e($e->id); ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <form action="<?php echo e(route('admin.cuelinksoffers.update_offer_img',$e->id)); ?>" method="post"
                    ...
                    <div class="form-group" id="viewerbox" style="display:none;margin-bottom:0%;">
                        <center>
                            <img style="width: 200px;border: 1px solid #3399db; border-radius: 10px; max-height:200px; padding: 11px;"
                                id="viewer" src="<?php echo e(asset('storage/app/public/offer')); ?>/<?php echo e($e['banner_image']); ?>"
                                alt="offer banner" />
                        </center>
                    </div>

                    <div class="mb-3">
                        <div class="form-label">Offer Image <small style="color: red">* (ratio=>2:1)</small></div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Codefuse\ecom\cashfuse-new\resources\views/admin/cuelinks/offer/list.blade.php ENDPATH**/ ?>