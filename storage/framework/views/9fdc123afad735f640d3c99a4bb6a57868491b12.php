                    ...
                    <tbody class="table-tbody">
                          <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<img src="<?php echo e(asset('storage/app/public/partner')); ?>/<?php echo e($coupon['image']); ?>" alt="no image" style="width:80px">
									...
									<td class="sort-name"><?php echo e($coupon['start_date']); ?></td>								
									<td class="sort-name"><?php echo e($coupon['end_date']); ?></td>
                                    <td class="sort-type">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cash.codefuse.org/httpdocs/newcashfuse/resources/views/admin/cuelinks/cue_coupon.blade.php ENDPATH**/ ?>