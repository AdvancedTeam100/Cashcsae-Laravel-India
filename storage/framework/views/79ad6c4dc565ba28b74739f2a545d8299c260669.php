                          ...
                          <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							 ...
							 <?php ($images=\App\Models\Image::where('product_id',$product['id'])->get()); ?>
								  ...
								  <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								   ...
								   <img src="<?php echo e(asset('storage/app/public/product')); ?>/<?php echo e($imag['image']); ?>" alt="image" style="max-width:20px; max-height:20px;">
                                 ...
                                 <td class="sort-id"><?php echo e(Str::limit($product->name,30)); ?></td>
                                   ...
                                   <td><?php if($product->status==1): ?> <a href="<?php echo e(route('admin.product.active',$product->id)); ?>?status=0" class="btn btn-danger">Inactive</a> <?php else: ?> <a href="<?php echo e(route('admin.product.active',$product->id)); ?>?status=1" class="btn btn-success">Active </a> <?php endif; ?></td>
                                    ...
                                    <label class="form-check form-check-single form-switch" for="stocksCheckbox<?php echo e($product->id); ?>">
                                        <input type="checkbox" class="form-check-input"
                                            onclick="myFunction<?php echo e($product->id+1); ?>()" id="stocksCheckbox<?php echo e($product->id); ?>"
                                            <?php echo e($product->trending?'checked':''); ?>>
                                    </label>
                                
                                 <script>
                                     function myFunction<?php echo e($product->id+1); ?>() {
                                   if (window.confirm('Do you want to change the Trending Status ?'))
                                 {
                                     window.location.href = "<?php echo e(route('admin.product.trending',[$product->id,$product->trending?0:1])); ?>"
                                 }
                                 }
                                 </script>  
                             </td>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/cash.codefuse.org/httpdocs/newcashfuse/resources/views/admin/product/list.blade.php ENDPATH**/ ?>